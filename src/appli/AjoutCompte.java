	...
	*/
	protected void createContents() throws SQLException
	{
		...
		btnValider.addSelectionListener(new SelectionAdapter()
		{
			...
			{
				String requete = "INSERT into utilisateurs (nom, prenom, email, mdp, role) Values('"+textNom.getText()+"','"+textPrenom.getText()+"','"+textEmail.getText()+"','"+textMdp.getText()+"',"+classeList.get(comboRole.getSelectionIndex())+")";
